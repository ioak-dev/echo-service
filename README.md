# Echo - Zettelkasten-inspired Note-Taking Platform
...
- Echo Python AI module (https://github.com/ioak-io/echo-ai)
...
1. Clone the repository: `git clone https://github.com/ioak-io/echo-service.git`
2. Navigate to the project directory: `cd echo-service`
